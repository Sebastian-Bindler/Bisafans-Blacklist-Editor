...
// Bisafans Blacklist Editor.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CBisafansBlacklistEditorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CBisafansBlacklistEditorApp-Erstellung

CBisafansBlacklistEditorApp::CBisafansBlacklistEditorApp()
{
...
// Das einzige CBisafansBlacklistEditorApp-Objekt

CBisafansBlacklistEditorApp theApp;


// CBisafansBlacklistEditorApp-Initialisierung

BOOL CBisafansBlacklistEditorApp::InitInstance()
{
	...
	CBisafansBlacklistEditorDlg dlg;
	m_pMainWnd = &dlg;
